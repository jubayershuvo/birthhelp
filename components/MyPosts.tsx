...
export default function MyPostsPage() {
  ...
  const getStatusBadge = (status: string) => {
    ...
    return (
      <span
        className={`px-2 py-1 rounded-full text-xs font-medium ${colors.light} ${colors.dark}`}
      >
      ...
      {filteredPosts.length === 0 ? (
        ...
        <div className="space-y-4">
          {filteredPosts.map((post) => (
            <div
              key={post._id}
              className="bg-white dark:bg-gray-800 rounded-lg shadow hover:shadow-md dark:shadow-gray-700/50 transition-shadow"
            >
              <div className="p-6">
                {/* Header */}
                <div className="flex flex-col md:flex-row md:items-start md:justify-between mb-4 gap-4">
                  ...
                  <div className="flex items-center gap-4">
                    <span className="text-xl font-bold text-gray-900 dark:text-white">
                      ৳{post.admin_fee + post.worker_fee + post.reseller_fee}
                    </span>
          ...
          <div className="relative w-full max-w-3xl max-h-[90vh] bg-white dark:bg-gray-800 rounded-xl shadow-2xl overflow-hidden">
            ...
            <div className="p-6 overflow-y-auto max-h-[calc(90vh-80px)]">
              <div className="space-y-6">
                    ...
                    <div className="bg-blue-50 dark:bg-blue-900/20 rounded-lg p-4">
                      <div className="space-y-2">
                        <p className="text-sm text-gray-700 dark:text-gray-300">
                          ...
                          {selectedPost.worker.name}
                        </p>
                        <p className="text-sm text-gray-700 dark:text-gray-300">
                          <span className="font-medium">ID:</span>{" "}
                          {selectedPost.worker._id}
                        </p>
                      </div>
                    </div>
                  </div>
                ...
                <div>
                  <h4 className="text-sm font-medium text-gray-500 dark:text-gray-400 mb-2">
                    Uploaded Files ({selectedPost.files.length})
                  </h4>
                    ...
                    {selectedPost.deliveryFile?.fileId ? (
                      ...
                      >
                        <div className="flex items-center min-w-0">
                          ...
                          <span
                            className="text-sm text-gray-700 dark:text-gray-300 truncate"
                            title={selectedPost.deliveryFile.name}
                          >
          ...
          <div className="relative w-full max-w-md bg-white dark:bg-gray-800 rounded-xl shadow-2xl">
            <div className="p-6">
              ...
              <p className="text-sm text-gray-500 dark:text-gray-400 text-center mb-6">
                ...
                service request and all associated data.
              </p>
          ...
          <div className="relative w-full max-w-md bg-white dark:bg-gray-800 rounded-xl shadow-2xl">
            <div className="p-6">
              ...
              <p className="text-sm text-gray-500 dark:text-gray-400 text-center mb-4">
                Please provide details about the issue with this service
                request. This will cancel the request and notify the
                administrator.
              </p>
              ...
              <div className="flex justify-center space-x-3">
                ...
                <button
                  ...
                  disabled={
                    isSubmittingReport || reportReason.trim().length < 10
                  }
