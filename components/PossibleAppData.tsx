        ...
        <div className="bg-white dark:bg-gray-800 rounded-2xl shadow-xl p-6 mb-8 transition-all hover:shadow-2xl">
          <div className="flex flex-col md:flex-row gap-4">
            ...
            <div className="flex items-end">
              ...
              <div className="ml-4">
                <Link
                  href="/possible-app-data/history"
                  className="px-4 py-3 bg-gradient-to-r from-gray-600 to-gray-700 hover:from-gray-700 hover:to-gray-800 text-white font-semibold rounded-xl flex items-center justify-center gap-2 transition-all"
                >
