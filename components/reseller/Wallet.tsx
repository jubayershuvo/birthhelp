...
const ACCOUNT_TYPES = [
  { value: "personal", label: "Personal", description: "ব্যক্তিগত অ্যাকাউন্ট" },
  { value: "merchant", label: "Merchant", description: "মার্চেন্ট অ্যাকাউন্ট" },
...
export default function WalletPage({ data }: { data: { percentage: number } }) {
  ...
  const handleSubmit = async () => {
    if (formData.amount && formData.number && formData.type) {
      ...
      try {
        ...
        if (res.ok) {
          ...
          setFormData({ amount: "", number: "", type: "" });
                ...
                {currentAmount > 0 && (
                  <div className="space-y-2">
                    ...
                    {!formData.type && (
                      <div className="flex items-center gap-2 text-red-600 dark:text-red-400 text-sm">
                        <AlertCircle className="w-4 h-4" />
                        <span>অ্যাকাউন্ট টাইপ নির্বাচন করুন</span>
                      </div>
                    )}
                    {currentAmount >= 50 &&
                      currentAmount <= reseller.balance &&
        ...
        {withdrawals.length > 0 ? (
          ...
          <div className="text-center py-12">
            ...
            <div className="text-gray-400 dark:text-gray-500 text-sm">
              এখনো কোন উত্তোলন রিকোয়েস্ট জমা দেননি
            </div>
          </div>
        )}
      </div>
