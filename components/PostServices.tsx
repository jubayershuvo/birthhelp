    ...
    <div className="min-h-screen bg-gradient-to-br from-gray-50 to-blue-50 dark:from-gray-900 dark:via-gray-800 dark:to-gray-900 text-gray-900 dark:text-white p-4 md:p-6">
      <div className="max-w-4xl mx-auto">
        ...
        {hasRequiredAttachments && (
          <div className="mb-8 bg-white/80 dark:bg-gray-800/80 backdrop-blur-sm rounded-2xl p-6 border border-gray-200 dark:border-gray-700">
            <div className="flex items-center justify-between mb-3">
              <span className="text-sm font-medium text-gray-700 dark:text-gray-300">
                Upload Progress
              </span>
              <span className="text-sm font-bold text-blue-600 dark:text-blue-400">
                {uploaded.length} of {selectedService.attachments.length} files
        ...
        <div className="bg-white/80 dark:bg-gray-800/80 backdrop-blur-sm rounded-2xl p-6 md:p-8 mb-6 border border-gray-200 dark:border-gray-700 shadow-lg">
          <label className="block mb-4 text-lg font-semibold text-gray-800 dark:text-gray-200 flex items-center gap-2">
          ...
          {loading ? (
            <div className="flex items-center justify-center p-8">
              <div className="animate-spin rounded-full h-10 w-10 border-4 border-blue-600 dark:border-blue-500 border-t-transparent" />
            </div>
          ) : (
            <select
              className="w-full p-4 bg-gray-50 dark:bg-gray-900/90 border border-gray-300 dark:border-gray-600 rounded-xl text-gray-900 dark:text-white focus:ring-2 focus:ring-blue-500 dark:focus:ring-blue-500 focus:border-transparent transition-all cursor-pointer hover:border-blue-500 dark:hover:border-blue-500"
              onChange={(e) => {
        ...
        {/* Description - Show always when service is selected */}
        {selectedService && (
        ...
        {selectedService && hasRequiredAttachments && (
          <div className="bg-white/80 dark:bg-gray-800/80 backdrop-blur-sm rounded-2xl p-6 md:p-8 mb-6 border border-gray-200 dark:border-gray-700 shadow-lg animate-slide-up">
        ...
        {/* Help Text - Only show if service has attachments */}
        {selectedService && hasRequiredAttachments && uploaded.length > 0 && (
          <div className="text-center">
            <div className="inline-flex items-center gap-2 text-sm text-gray-600 dark:text-gray-400">
              <AlertCircle className="w-4 h-4" />
              <span>
                You can remove uploaded files by clicking the remove (×) button
              </span>
            </div>
          </div>
        )}
